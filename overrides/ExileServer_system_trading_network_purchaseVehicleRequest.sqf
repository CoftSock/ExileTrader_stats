...
try 
{
	...
	format["carbuyHistory:%1:%2:%3:%4:%5",(getPlayerUID _playerObject), _salesPrice, _vehicleClass, str(mapGridPosition getPos _playerObject), _playerMoney] call ExileServer_system_database_query_fireAndForget;
