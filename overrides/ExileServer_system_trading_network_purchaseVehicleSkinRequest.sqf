...
try 
{
	...
	format["modbuyHistory:%1:%2:%3:%4:%5:%6", (getPlayerUID _playerObject), _salesPrice, _vehicleNetID, str(mapGridPosition getPos _playerObject), _playerMoney, _skinClassName] call ExileServer_system_database_query_fireAndForget;
